        ...
        if (!empty($type)) {
          ...
          foreach ($type as $row): 
            ...
            <tr>
              ...
              <td>
                <a href="#" class="btn btn-info btn-xs btnEdit mb-1" data-toggle="modal" data-target="#add" data-id="<?php echo $row->type_id ?>" data-name="<?php echo $row->type_name ?>"><i class="fas fa-edit"></i> Ubah</a>
              </td>
            </tr>
          <?php endforeach; 
        } else {
